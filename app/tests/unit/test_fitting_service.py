...
def test_start_fitting_job_returns_job_start_response(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(service.job_manager, "is_job_running", lambda _job_type: False)
    monkeypatch.setattr(service.job_manager, "start_job", lambda **_kwargs: "fit12345")
