...
from app.server.common.constants import RESOURCES_PATH, DATABASE_FILENAME
from app.server.common.utils.encoding import sanitize_dataframe_strings
from app.server.common.utils.security import ensure_safe_sql_identifier
from app.server.common.utils.logger import logger
from app.server.repositories.database.sql import sqlite_enable_foreign_keys_sql
from app.server.repositories.database.upsert import resolve_conflict_columns
from app.server.repositories.schemas.models import Base
...
class SQLiteRepository:
    ...
    def upsert_dataframe(self, df: pd.DataFrame, table_cls) -> None:
        ...
        try:
            ...
            max_rows_for_sqlite = max(1, SQLITE_MAX_VARIABLES // columns_per_row)
            effective_batch_size = max(
                1, min(self.insert_batch_size, max_rows_for_sqlite)
            )
