...
application worktree was clean before this documentation-only change. Evidence
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `runtime.startup.windows` | `WORKING` | Official Windows launcher, one backend/frontend lifecycle, port ownership, browser opening, stop, and application-process cleanup. | [`adsmod-end-to-end-audit-2026-09-10.md`](../QA/adsmod-end-to-end-audit-2026-09-10.md) passed launcher lifecycle and occupied-port checks; startup/process-control docs were updated after that run. | The launcher process-control and cache changes landed on 2026-09-18, after the last full lifecycle/browser run. No failure is currently evidenced, but that run is not current enough for `VALIDATED`. | — | 2026-09-10 (pre-2026-09-18 launcher changes) | Manual E2E | [`runtime/startup.md`](runtime/startup.md); [`runtime/deployment.md`](runtime/deployment.md) | Re-run start/stop/start/stop, occupied-port protection, cleanup, readiness, and final port checks on the current checkout. |
