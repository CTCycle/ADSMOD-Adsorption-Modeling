...
| --- | --- | --- | --- |
| Tier 0 — environment and startup | `ADS-T0-01`, `ADS-T0-02` | `PASS` / `FAIL` | CI executability is closed by run `35622186997`; launcher occupied-port refusal remains the only open Tier 0 gate. |
