...
| --- | --- | --- | --- |
| Tier 0 — environment and startup | `ADS-T0-01`, `ADS-T0-02` | `PASS` / `PASS` | CI and official launcher gates are closed; Tier 1 is the next untested campaign tier. |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `runtime.startup.windows` | `VALIDATED` | Official Windows launcher, backend/frontend lifecycle, port ownership, browser opening, stop, relaunch, and application-process cleanup. | [`ADS-T0-02/launcher-lifecycle.md`](../QA/validation/2026-09-21/ADS-T0-02/launcher-lifecycle.md) records clean start/readiness/browser/owned-stop/relaunch plus safe refusal for controlled listeners on 6045 and 5173; final listener checks were free. | — | — | 2026-09-21 (Tier 0 launcher regression after active-listener fallback) | Manual E2E + browser + process/port checks | [`validation/roadmap.md`](validation/roadmap.md); [`runtime/startup.md`](runtime/startup.md); [`ADS-T0-02/launcher-lifecycle.md`](../QA/validation/2026-09-21/ADS-T0-02/launcher-lifecycle.md) | Revalidate after launcher, runtime, cache, or process-ownership changes. |
...
| `quality.validation-gates` | `VALIDATED` | Backend/frontend tests, lint, build, generated contracts, visual checks, and repository-local cache layout. | [`ADS-T0-01/ci-workflow.md`](../QA/validation/2026-09-21/ADS-T0-01/ci-workflow.md) records final run `35622186997`: all three CI jobs passed, including generated OpenAPI/config-schema diffs and all seven visual projects; the current-checkout cache-layout test also passed locally (`3 passed`). | This is current CI/gate evidence, not a claim that every live product workflow or later Tier 1–5 slice is validated. Protected pytest-cache directories can still produce Windows access-denied cleanup warnings during unrelated cleanup. | Repeat after workflow, dependency, runtime, or generated-contract changes. | 2026-09-21 (Tier 0 final CI run) | Remote workflow + job logs + targeted local cache test | [`validation/roadmap.md`](validation/roadmap.md); [`coding/quality_gates.md`](coding/quality_gates.md); [`operations/commands.md`](operations/commands.md); [`ADS-T0-01/ci-workflow.md`](../QA/validation/2026-09-21/ADS-T0-01/ci-workflow.md) | Preserve the gate and rerun it when its inputs change. |
...
| --- | --- | --- | --- |
| `ADS-T0-01` | High / current gate pass | No remaining gap in the defined CI slice; repeat after workflow, dependency, runtime, or generated-contract changes. | Low |
| `ADS-T0-02` | High / current gate pass | No remaining gap in the defined launcher lifecycle slice; repeat after launcher, runtime, cache, or process-ownership changes. | Low |
| `runtime.startup.windows` | High / current gate pass | No remaining gap in the defined official-launcher lifecycle; repeat after launcher, runtime, cache, or process-ownership changes. | Low |
...
| `quality.validation-gates` | High / current gate pass | No remaining gap in the defined current CI/cache-layout gate; repeat after workflow, dependency, runtime, or generated-contract changes. | Low |
