...
is now closed; Tier 1 is now closed. Tier 2 is in progress: `ADS-T2-01` through
`ADS-T2-03` passed on implementation commit `c876a063`, while `ADS-T2-04`
through `ADS-T2-06` remain untested.

| Tier | Slice IDs | Status | Current gate |
| --- | --- | --- | --- |
| Tier 0 — environment and startup | `ADS-T0-01`, `ADS-T0-02` | `PASS` / `PASS` | CI run `35876297668` passed all three jobs on `6154532`; the official launcher lifecycle and conflict/race evidence remains at `2eb3bc1`, with no launcher source changes since. |
...
| Tier 2 — core product workflows | `ADS-T2-01`–`ADS-T2-06` | `PARTIAL` | `ADS-T2-01`–`ADS-T2-03` passed on `c876a06`; `ADS-T2-04`–`ADS-T2-06` remain untested. |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `ADS-T0-01` | Current GitHub Actions quality gates | YES | YES | `PASS` | `6154532dd6628bb70e98fae6fa427e2d9108cd5f` | None in the required gate; hosted annotations are platform maintenance warnings only | [`ADS-T1-03/summary.md`](../QA/validation/2026-09-23/ADS-T1-03/summary.md); [`ADS-T0-01/ci-workflow.md`](../QA/validation/2026-09-22/ADS-T0-01/ci-workflow.md); [hosted run 35876297668](https://github.com/CTCycle/ADSMOD-Adsorption-Modeling/actions/runs/35876297668) | — | hosted CI + local exact gates |
...
| `ADS-T2-04` | Dataset/experiment selection, fitting configuration, all nine model cards, and parameter forms | YES | NO | `UNTESTED` | — | — | — | Exercise the full selection and configuration UI slice. | — |
| `ADS-T2-05` | Positive asynchronous fitting, metrics/result rendering, persistence, and reload | YES | NO | `UNTESTED` | — | — | — | Complete a positive fitting run and verify rendered/persisted results. | — |
| `ADS-T2-06` | Fitting cancellation, duplicate-job prevention, recovery, and clean follow-up execution | YES | NO | `UNTESTED` | — | — | — | Exercise cancellation and recovery, then verify a clean follow-up run. | — |
...
| `quality.validation-gates` | `VALIDATED` | Backend/frontend tests, lint, build, generated contracts, visual checks, profile-correct runner behavior, and repository-local cache layout. | Hosted run `35876297668` on SHA `6154532` passed all three jobs; local `ADS-T1-03` frontend unit, lint, and build gates also passed. | Protected pre-existing Windows cache directories can produce local ACL/cache warnings; the hosted gate passes. Hosted Node.js 20 and future Ubuntu image annotations remain platform maintenance warnings. | — | 2026-09-23 | Hosted CI + local automated gates | [`validation/roadmap.md`](validation/roadmap.md); [`coding/quality_gates.md`](coding/quality_gates.md); [`operations/commands.md`](operations/commands.md); [`ADS-T1-03/summary.md`](../QA/validation/2026-09-23/ADS-T1-03/summary.md); [`ADS-T1-02/summary.md`](../QA/validation/2026-09-23/ADS-T1-02/summary.md); [`ADS-T0-02/launcher-lifecycle.md`](../QA/validation/2026-09-22/ADS-T0-02/launcher-lifecycle.md) | Revalidate the three-job workflow and affected profile suites after future changes. |
