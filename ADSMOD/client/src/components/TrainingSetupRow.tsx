...
interface TrainingSetupRowProps {
    ...
    viewMode?: TrainingSetupViewMode;
...
export const TrainingSetupRow: React.FC<TrainingSetupRowProps> = ({
    ...
    const showDatasets = viewMode === 'all' || viewMode === 'datasets';
    const showCheckpoints = viewMode === 'all' || viewMode === 'checkpoints';

    return (
        <div className="training-setup-container">
            {showDatasets && (
                <div className="section-container">
                    {showSectionHeading && <h3 className="split-selection-title">Training Datasets</h3>}
                    ...
                    <div className="split-selection-card">
                                        ...
                                        {processedDatasets.length === 0 ? (
                                            ...
                                            processedDatasets.map((ds) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="split-table-cell">{ds.train_samples}</td>
                                                    <td className="split-table-cell">{ds.validation_samples}</td>
                                                    <td className="split-table-cell split-table-cell-right">
                                                        <div className="split-table-actions-wrap">
                                                            <button
                                                                onClick={(e) => {
                                                                    e.stopPropagation();
                                                                    onViewDatasetMetadata(ds.dataset_label);
                                                                }}
                                                                title="View Metadata"
                                                            ...
                                                            <button
                                                                onClick={(e) => {
                                                                    e.stopPropagation();
                                                                    onDeleteDataset(ds.dataset_label);
                                                                }}
                        ...
                        <div className="split-selection-card-right">
                            <div className="split-selection-card-header-row">
                                ...
                                <h4 className="split-selection-card-title">Start Training Run</h4>
                            </div>

                            <p className="split-selection-card-description split-selection-card-description-wide">
                                Select a processed adsorption dataset and open the training setup.
                            </p>
                            ...
                            <div className="split-selection-card-actions split-selection-card-actions-single">
                                <button
            ...
            {showCheckpoints && (
                <div className="section-container">
                    {showSectionHeading && <h3 className="split-selection-title">Checkpoints</h3>}
                    ...
                    <div className="split-selection-card">
                                        ...
                                        {checkpoints.length === 0 ? (
                                            ...
                                            checkpoints.map((cp) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="split-table-cell">{cp.epochs_trained ?? '-'}</td>
                                                    <td className="split-table-cell">{cp.final_loss?.toFixed(4) ?? '-'}</td>
                                                    <td className="split-table-cell split-table-cell-right">
                                                        <div className="split-table-actions-wrap">
                                                            <button
                                                                onClick={(e) => {
                                                                    e.stopPropagation();
                                                                    onViewCheckpointDetails(cp.name);
                                                                }}
                                                                title="View Details"
                                                                className="icon-action-button"
                                                                type="button"
                        ...
                        <div className="split-selection-card-right">
                            <div className="split-selection-card-header-row">
                                ...
                                <h4 className="split-selection-card-title">Resume Training Run</h4>
                            </div>

                            <p className="split-selection-card-description">
                                Continue model training from a saved checkpoint.
                            </p>
